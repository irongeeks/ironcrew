...
function resolveProgressStatusLabel(status: string, lang: Lang): string {
  const labels: Record<string, Record<Lang, string>> = {
    inbox: { ko: "접수", en: "Inbox", ja: "受信", zh: "Inbox", de: "Eingang" },
    planned: { ko: "계획", en: "Planned", ja: "計画", zh: "Planned", de: "Geplant" },
    collaborating: { ko: "협업", en: "Collaborating", ja: "協業", zh: "Collaborating", de: "Zusammenarbeit" },
    in_progress: { ko: "진행", en: "In Progress", ja: "進行中", zh: "In Progress", de: "In Bearbeitung" },
    review: { ko: "검토", en: "Review", ja: "レビュー", zh: "Review", de: "Überprüfung" },
    pending: { ko: "보류", en: "Pending", ja: "保留", zh: "Pending", de: "Ausstehend" },
    done: { ko: "완료", en: "Done", ja: "完了", zh: "Done", de: "Erledigt" },
    cancelled: { ko: "취소", en: "Cancelled", ja: "取消", zh: "Cancelled", de: "Abgebrochen" },
  };
...
export function sendProjectProgressReply(
  ...
  void (async () => {
    ...
    log.warn({ err, agent: agent.name }, "failed to send progress reply");
  });
}
