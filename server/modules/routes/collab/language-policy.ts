...
const ROLE_LABEL_L10N: Record<string, Record<Lang, string>> = {
  team_leader: { ko: "팀장", en: "Team Lead", ja: "チームリーダー", zh: "Team Lead", de: "Teamleiter" },
...
export function initializeCollabLanguagePolicy(deps: LanguagePolicyDeps) {
  ...
  function l(ko: string[], en: string[], ja?: string[], zh?: string[], de?: string[]): L10n {
    return {
      ko,
      en,
      ja: ja ?? en.map((s) => s),
  ...
  function getFlairs(agentName: string, lang: Lang): string[] {
    const flairs: Record<string, Record<Lang, string[]>> = {
      Aria: {
        ...
        zh: ["reviewing code", "planning a refactor", "checking PRs"],
        de: ["beim Code-Review", "beim Refactoring planen", "beim PR-Check"],
      },
      Bolt: {
        ko: ["빠르게 코딩하면서", "API 설계하면서", "성능 튜닝하면서"],
        en: ["coding fast", "designing APIs", "tuning performance"],
        ja: ["高速コーディング中", "API設計しながら", "パフォーマンスチューニング中"],
        zh: ["coding fast", "designing APIs", "tuning performance"],
        de: ["beim schnellen Coden", "beim API-Design", "beim Performance-Tuning"],
      },
      Nova: {
        ...
        zh: ["studying new tech", "building a prototype", "writing experimental code"],
        de: ["beim Studieren neuer Technik", "beim Prototyp-Bau", "beim experimentellen Coden"],
      },
      Pixel: {
        ...
        zh: ["working on mockups", "organizing components", "updating the UI guide"],
        de: ["beim Mockup-Erstellen", "beim Komponenten-Ordnen", "beim UI-Guide-Update"],
      },
      Luna: {
        ...
        zh: ["working on animations", "refining the color palette", "analyzing UX"],
        de: ["beim Animieren", "beim Farbpaletten-Feinschliff", "bei der UX-Analyse"],
      },
      Sage: {
        ...
        zh: ["reviewing market analysis", "organizing strategy docs", "researching competitors"],
        de: ["bei der Marktanalyse", "beim Strategie-Docs ordnen", "bei der Wettbewerbsrecherche"],
      },
      Clio: {
        ...
        zh: ["analyzing data", "drafting a proposal", "organizing user interviews"],
        de: ["bei der Datenanalyse", "beim Konzeptschreiben", "beim Nutzerinterview-Ordnen"],
      },
      Atlas: {
        ...
        zh: ["monitoring servers", "checking deploy pipelines", "reviewing ops metrics"],
        de: ["beim Server-Monitoring", "beim Deploy-Pipeline-Check", "beim Ops-Metriken-Review"],
      },
      Turbo: {
        ...
        zh: ["running automation scripts", "optimizing CI/CD", "cleaning up infra"],
        de: ["beim Automatisierungsskript", "beim CI/CD-Optimieren", "beim Infra-Aufräumen"],
      },
      Hawk: {
        ...
        zh: ["reviewing test cases", "analyzing bug reports", "checking quality metrics"],
        de: ["beim Testfall-Review", "bei der Bug-Report-Analyse", "beim Qualitätsmetriken-Check"],
      },
      Lint: {
        ...
        zh: ["writing automated tests", "inspecting code", "running regression tests"],
        de: ["beim automatisierten Testen", "bei der Code-Inspektion", "beim Regressionstests laufen"],
      },
      Vault: {
        ...
        zh: ["running a security audit", "reviewing vuln scan results", "checking auth logic"],
        de: ["beim Sicherheits-Audit", "beim Schwachstellen-Scan-Review", "beim Auth-Logik-Check"],
      },
      Pipe: {
        ...
        zh: ["building pipelines", "configuring containers", "automating deployments"],
        de: ["beim Pipeline-Bau", "beim Container-Konfigurieren", "beim Deploy-Automatisieren"],
      },
    };
    ...
    const defaults: Record<Lang, string[]> = {
      ...
      zh: ["working on tasks", "making progress", "getting things done"],
      de: ["bei der Aufgabenbearbeitung", "beim Fortschritt machen", "beim Arbeiten"],
    };
  ...
  function classifyIntent(msg: string, lang: Lang) {
    const checks: Record<string, RegExp[]> = {
      greeting: [
        ...
        /你好|嗨|早上好|下午好|晚上好/i,
        /hallo|guten\s*(morgen|tag|abend)|moin|servus|grüß/i,
      ],
      presence: [
        ...
        /いますか|席に|いる？|応答/i,
        /在吗|在不在|有人吗/i,
        /bist du (da|hier|verfügbar|am platz)|jemand da|anwesend/i,
      ],
      whatDoing: [
        ...
        /何してる|忙しい|暇|何やってる/i,
        /在做什么|忙吗|有空吗|在干嘛/i,
        /was machst du|woran arbeitest|beschäftigt|frei|was gibt('?s| es)/i,
      ],
      report: [
        ...
        /報告|進捗|状況|ステータス/i,
        /报告|进度|状态|进展/i,
        /bericht|status|fortschritt|ergebnis|wie (steht|läuft|geht)/i,
      ],
      praise: [
        ...
        /做得好|辛苦|谢谢|太棒了|厉害/i,
        /gut gemacht|danke|toll|super|klasse|ausgezeichnet|prima|spitze|wunderbar/i,
      ],
      encourage: [
        ...
        /頑張|ファイト|応援/i,
        /加油|努力|拜托/i,
        /weiter so|du schaffst das|halt durch|mach weiter|viel erfolg/i,
      ],
      joke: [
        ...
        /笑|面白い|冗談|暇/i,
        /哈哈|笑|开玩笑|无聊/i,
        /haha|witz|lustig|langweilig|spaß/i,
      ],
      complaint: [
        ...
        /遅い|イライラ|なぜ|いつ|急いで/i,
        /慢|着急|为什么|快点|延迟/i,
        /langsam|frustrierend|warum|wann|schneller|verzöger|spät|dauert (zu )?lang/i,
      ],
      opinion: [
        ...
        /どう思う|意見|アイデア|提案/i,
        /怎么看|意见|想法|建议/i,
        /was denkst du|meinung|idee|vorschlag|wie wäre|empfehl/i,
      ],
      canDo: [
        ...
        /できる|可能|お願い|頼む|やって/i,
        /能不能|可以|拜托|帮忙|处理/i,
        /kannst du|könntest du|möglich|in der lage|übernehm|bitte|kümmern/i,
      ],
      question: [
        ...
        /\?|何|どこ|いつ|なぜ|どう/i,
        /\?|什么|哪里|什么时候|为什么|怎么/i,
        /\?|was\b|wo\b|wann|warum|wie\b|welch|wer\b/i,
      ],
    };

    const langIdx = { ko: 0, en: 1, ja: 2, zh: 3, de: 4 }[lang];
    void langIdx;
