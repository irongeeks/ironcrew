        ...
        >
          <div>
            <h3 className="text-base font-semibold" style={{ color: "var(--th-text-heading)" }}>
              {t({ en: "Skill Learning Squad", de: "Skill-Lernteam" })}
            </h3>
          ...
          >
            {learnInProgress ? t({ en: "Running", de: "Läuft" }) : t({ en: "Close", de: "Schließen" })}
          </button>
        </div>
        ...
        <div className="space-y-4 overflow-y-auto px-5 py-4 max-h-[calc(90vh-72px)]">
          <div className="rounded-xl border border-emerald-500/25 bg-emerald-500/8 px-3 py-2">
            <div className="text-[11px] text-emerald-200">
              {t({ en: "Install command", de: "Installationsbefehl" })}
            </div>
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="text-xs" style={{ color: "var(--th-text-secondary)" }}>
              {t({ en: "Select CLI representatives (multi-select)", de: "CLI-Vertreter auswählen (Mehrfachauswahl)" })}
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {representatives.map((row) => {
              ...
              const displayName = row.agent
                ...
                : t({ en: "No assigned member", de: "Kein zugewiesenes Mitglied" });
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    ...
                    >
                      ...
                      {isHitAnimating && <span className="unlearn-hit-text">{t({ en: "Bonk!", de: "Bam!" })}</span>}
                    </div>
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-[11px]" style={{ color: "var(--th-text-muted)" }}>
                        {row.agent ? roleLabel(row.agent.role, t) : t({ en: "Unavailable", de: "Nicht verfügbar" })}
                      </div>
                    </div>
                    ...
                    <div className="flex shrink-0 flex-col items-end gap-1.5">
                      ...
                      {isAlreadyLearned && (
                        ...
                        >
                          {isUnlearning
                            ? t({ en: "Unlearning...", de: "Verlernen..." })
                            : t({ en: "Unlearn", de: "Verlernen" })}
                        </button>
                      )}
                    </div>
                  </div>
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-2 text-xs">
              <div style={{ color: "var(--th-text-secondary)" }}>
                {t({ en: "Job status", de: "Auftragsstatus" })}:{" "}
                <span
            ...
            {learnJob && (
              ...
              >
                ...
                {learnJob.logTail.length > 0 ? (
                  ...
                  <div className="text-slate-600">{t({ en: "No logs yet", de: "Noch keine Protokolle" })}</div>
                )}
              </div>
            )}
          </div>
          ...
          <div className="flex justify-end gap-2">
            ...
            >
              {learnSubmitting || learnInProgress
                ? t({ en: "Learning...", de: "Lernen..." })
                : t({ en: "Start Learning", de: "Lernen starten" })}
            </button>
          </div>
        </div>
      </div>
