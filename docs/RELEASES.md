...
## Aktueller Quellrelease 0.4.5

Für **0.4.5** gilt der Einstieg im Workspace [`next/`](../next/README.md) mit
...
Die [vollständige Updateanleitung](releases/v0.4.5.md#update-von-04x) und die
