...
Für kostenlose Workflows ist `openrouter/free` der empfohlene Einstieg; einzelne `:free`-Endpunkte können vorübergehend fehlen. [Auswahl und Diagnose](docs/model-access-troubleshooting.md#kostenlose-modelle).
