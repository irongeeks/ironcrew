...
export type OrderStatus =
  ...
  | "cancelled"
  | "failed";
export type WaitReason = "approval" | "budget" | "external" | "worker" | "tool_error" | "unknown_effect" | "user_input";
...
export interface Order {
  id: Id;
  scope: Scope;
  kind: "website" | "incident" | "finance" | "research";
  goal: string;
  leadEmployeeId: Id;
  status: OrderStatus;
