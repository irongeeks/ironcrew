...
## Getrennte Messstände

Am 2026-09-07T12:24:09.878Z wurde der damalige unveränderte Build nach dem damaligen Vollgate auf Apple M5 / darwin 25.6.0 arm64 geprüft. Es liefen keine parallelen Paket-/Update-Lasttests. Ergebnisse: initiales Nicht-3D-JavaScript **151682 Bytes gzip-equivalent**, HQ-Anfangsressourcen **1778584 Bytes gzip-equivalent**, **P95 23 ms** aus 118 tatsächlichen Tastatureingaben bei 1000 über HTTP angelegten Aufträgen. Alle drei vorgegebenen Schwellen wurden eingehalten. Die sechs Empty-/Blocked-Ansichten meldeten **keine Axe-Verstöße**; im JSON ausgewiesene unvollständig automatisch prüfbare Regeln bleiben eine manuelle Nachweisgrenze.

Ressourcen-Hashes, Rohsamples, Gerät und Zeitpunkt stehen im verlinkten Ergebnisdokument. Die getrennte Hallenmessung wurde im vollständigen lokalen E2E-Lauf am 2026-09-07T15:37:56.749Z erneuert: **41,64 FPS** auf demselben benannten Apple M5, oberhalb der 30-FPS-Schwelle; siehe [crew-visual-validation.md](crew-visual-validation.md). Die Kapazitätsmessung mit **P95 23 ms** und ihren Ressourcen-Hashes bleibt auf den hier genannten Zeitpunkt um 12:24 UTC gebunden.

Der neuere [lokale Gesamtgatebericht](test-evidence/gates.json) zur Basis `686022a9a0f02f7ff8a93e120c4e82965c13a379` weist **508 bestandene Tests ohne Skips**, davon **46 E2E-Fälle**, und ein erfolgreiches Dependency-Audit ohne bekannte Schwachstellen aus. Dieser Lauf wiederholte die Hallenmessung, nicht das separate Kapazitätsskript. Die [Drei-OS-CI 34139199380](https://github.com/irongeeks/ironcrew/actions/runs/34139199380) hat diesen abschließenden Stand auf macOS 15, Windows Server 2025 und Ubuntu 24.04 vollständig bestanden: **jeweils 508 Tests, 12 erfolgreiche Gates und keine Skips**. Die Originalberichte sind für [macOS](test-evidence/ci/686022a-macos-15/gates.json), [Windows](test-evidence/ci/686022a-windows-2025/gates.json) und [Ubuntu](test-evidence/ci/686022a-ubuntu-24.04/gates.json) gespeichert. Der [Linux-Isolationslauf 34139199314](https://github.com/irongeeks/ironcrew/actions/runs/34139199314) ist erfolgreich; die [Originalbelege](test-evidence/ci/linux-686022a/github-run.json) sind dauerhaft gespeichert. Die vorherige [Drei-OS-CI 34137823550](https://github.com/irongeeks/ironcrew/actions/runs/34137823550) zu `ebf3b98` bestand bereits jeweils 508 Tests ohne Skips auf macOS, Windows und Ubuntu. Dieser historische Erfolg ist im [CI-Verzeichnis](test-evidence/ci/README.md) archiviert und wird nicht auf einen anderen Commit übertragen.
